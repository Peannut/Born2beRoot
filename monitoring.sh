...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/12/08 11:52:11 by zoukaddo          #+#    #+#              #
#    Updated: 2021/12/08 11:52:12 by zoukaddo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

#!/bin/bash

wall "    #Architecture: $(uname -a | awk '{printf("%s", $0)}')
    ...
    #LVM use: $(lsblk | grep lvm | wc -l | awk '{if($0!="0"){printf("yes")}else{printf("no")}}')
